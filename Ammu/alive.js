...
© IMASH NIDUSHA
 `.trim()
    await conn.send2ButtonLoc(m.chat, await (await fetch("https://www.linkpicture.com/q/20211229_144640.jpg")).buffer(), devil, '© ⁨ɪͥᴛͭsᷤ ᴍᷟᴇͤ ī.am 𝜡𝛯ᗪ⁴⁰⁴⁩⁩', 'ᴀɢʀᴇᴇ ᴛᴏ ʀᴜʟᴇꜱ', '.? menu', 'ᴀɢʀᴇᴇ ʀᴜʟꜱᴇ', ',owner' )
}
handler.tags = ['main']
handler.help = ['rules']
